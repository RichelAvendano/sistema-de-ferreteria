            ...
            <div class="columns">
                <div class="column is-two-thirds pb-0">
                    <div style="display:flex; justify-content : center">
                        <h1 class="title is-inline" style="margin-top:0px;padding-right:10px"> FerreCopArt </h1>
                    </div>

                    <h2 class="subtitle has-text-centered" style="margin:0">Tu Aliado en Construcción y Reparación</h2>
...
$dompdf->stream('mi_archivo.pdf', array("Attachment" => 1));
