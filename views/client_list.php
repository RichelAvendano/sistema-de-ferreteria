...
<div class="background-image" style="height:100%;min-height: 100vh;" >
    ...
    <div class="box is-inline-block has-background-link-95 ml-3 mb-0 mt-2 p-4">
        <h1 class="title is-4 has-text-black has-text-centered">Clientes</h1>
        <h2 class="subtitle has-text-black has-text-centered">Lista Clientes</h2>
    </div>
    <div class="container pb-2 pt-2"> 
        ...
        <?php 
            ...
            $url = "index.php?view=client_list&page=";
            $registros = 10;
            $busqueda = "";
