<div class="background-image" style="height:100%;min-height: 100vh;">
    ...
    <div class="container pb-3 pt-3">
        ...
        <?php
            ...
            $search_op = isset($_SESSION['search_op']) ? $_SESSION['search_op'] : 'usuario';
                        ...
                        <div class="control">
                            <div class="select">
                                <select name="search_op">
                                    <option value="usuario" <?php echo ($search_op === 'usuario') ? 'selected' : ''; ?>>Usuario</option>
                                </select>
                            </div>
                        </div>
                        <p class="control is-expanded">
                            <input class="input is-rounded" type="text" name="txt_buscador" placeholder="Buscar..." pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" maxlength="30" value="<?php echo isset($_SESSION['busqueda_usuario']) ? htmlspecialchars($_SESSION['busqueda_usuario']) : ''; ?>">
                        </p>
                        <p class="control">
        ...
        <div class="columns" style="margin-bottom:0px">
            <div class="column">
                <form class="has-text-centered" action="" method="POST" autocomplete="off" >
                    ...
                    <?php
                        if(!empty($_SESSION['busqueda_usuario'])){
                            echo '
                                <div class="container is-fluid">
                                    <span class="subtitle has-background-white p-2">Estas buscando: <strong>'.$_SESSION['busqueda_usuario'].'</strong></span>
                                </div>
