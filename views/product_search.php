    ...
    <div class="container pb-2">
        <?php 
            ...
            if(isset($_GET['busqueda'])){
                $_SESSION['busqueda_producto'] = $_GET['busqueda'];
            }
                        ...
                        <div class="control">
                            <div class="select">
                                <select name="search_op">
                                    ...
                                    <option value="stock" <?php echo ($search_op === 'stock') ? 'selected' : ''; ?>>Inventario</option>
                                    <option value="precio" <?php echo ($search_op === 'precio') ? 'selected' : ''; ?>>Precio</option>
                                    <option value="foto" <?php echo ($search_op === 'foto') ? 'selected' : ''; ?>>Nombre de foto</option>
                                </select>
                            </div>
                        </div>
                        <p class="control is-expanded">
                            <input class="input is-rounded" type="text" name="txt_buscador" placeholder="Buscar..." pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" maxlength="30" value="<?php echo isset($_SESSION['busqueda_producto']) ? htmlspecialchars($_SESSION['busqueda_producto']) : ''; ?>">
                        </p>
                        <p class="control">
        ...
        <div class="columns" style="margin-bottom:0px">
            <div class="column">
                <form class="has-text-centered" action="" method="POST" autocomplete="off" >
                    ...
                    <?php
                        if(isset($_SESSION['busqueda_producto']) && $_SESSION['busqueda_producto']!= "" ){
                            echo '
                                <div class="container is-fluid">
                                    <span class="subtitle has-background-white p-2">Estas buscando: <strong>'.$_SESSION['busqueda_producto'].'</strong></span>
                                </div>
        ...
        <?php
            ...
            $url = "index.php?view=product_search&page=";
            $registros = 15;
