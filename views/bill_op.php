...
<section class="section pt-0 mt-5 ml-6 mr-6">
  ...
  <div class="columns is-mobile is-centered">
    <div class="column is-full is-one-quarter p-2 is-flex is-flex-direction-column is-align-items-center is-justify-content-center has-text-centered has-background-white" style="min-width:180px">     
      ...
      <div class="box title is-5 p-2 has-background-warning-95 mt-2" style="text-align:center">Estas en Facturas</div>  
    </div>
  </div>
  ...
  <div class="columns is-mobile is-multiline is-centered">
    ...
    <div class="column is-narrow is-one-quarter p-5 is-flex is-flex-direction-column is-align-items-center is-justify-content-center has-text-centered" style="min-width:180px">
      <a href="index.php?view=bill_new" class="hover-effect p-2 has-background-white">
        <figure class="image is-128x128">
    ...
    <div class="column is-narrow is-one-quarter p-5 is-flex is-flex-direction-column is-align-items-center is-justify-content-center has-text-centered" style="min-width:180px">
      <a href="index.php?view=bill_list" class="hover-effect p-2 has-background-white">
        <figure class="image is-128x128">
    ...
    <div class="column is-narrow is-one-quarter p-5 is-flex is-flex-direction-column is-align-items-center is-justify-content-center has-text-centered" style="min-width:180px">
      <a href="index.php?view=bill_search_op_1" class="hover-effect p-2 has-background-white">
        <figure class="image is-128x128 ml-3">
          <img src="img/buscar_id.png"/>         
        </figure>
        <div class="box title is-6 p-2 has-background-link-95" style="text-align:center;max-width:160px">Buscar por Nombre o Cedula</div>
      </a>  
    </div>
    <div class="column is-narrow is-one-quarter p-5 is-flex is-flex-direction-column is-align-items-center is-justify-content-center has-text-centered" style="min-width:180px">
      <a href="index.php?view=bill_search_op_2" class="hover-effect p-2 has-background-white">
        <figure class="image is-128x128 ml-3">
          <img src="img/buscar_fecha.jpg"/>         
        </figure>
        <div class="box title is-5 p-2 has-background-link-95" style="text-align:center;max-width:150px">Buscar Por Fecha</div>
      </a>  
    </div>
    <div class="column is-narrow is-one-quarter p-5 is-flex is-flex-direction-column is-align-items-center is-justify-content-center has-text-centered" style="min-width:180px">
      <a href="index.php?view=bill_search_op_3" class="hover-effect p-2 has-background-white">
        <figure class="image is-128x128 ml-3">
          <img src="img/buscar_monto.png"/>         
        </figure>
        <div class="box title is-5 p-2 has-background-link-95" style="text-align:center;max-width:150px">Buscar Por Monto</div>
      </a>  
    </div>
    <div class="column is-narrow is-one-quarter p-5 is-flex is-flex-direction-column is-align-items-center is-justify-content-center has-text-centered" style="min-width:180px">
      <a href="index.php?view=bill_price_dolar_conversor" class="hover-effect p-2 has-background-white">
        <figure class="image is-128x128 ml-3">
          <img src="img/conversor_moneda.jpg"/>         
        </figure>
        <div class="box title is-5 p-2 has-background-link-95" style="text-align:center;max-width:150px">Conversor de Moneda</div>
      </a>  
    </div>
  </div>
</section>
