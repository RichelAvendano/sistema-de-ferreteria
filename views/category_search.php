...
<div class="background-image" style="height:100%;min-height: 100vh;" >
    ...
    <div class="box is-inline-block has-background-link-95 ml-3 mb-0 mt-2 p-4">
        ...
        <h2 class="subtitle has-text-black has-text-centered">Buscar Categorias</h2>
    </div>
                        ...
                        <div class="control">
                            <div class="select">
                                <select name="search_op">
                                    ...
                                    <option value="ubicacion" <?php echo ($search_op === 'ubicacion') ? 'selected' : ''; ?>>Ubicacion</option>
                                </select>
                            </div>
                        </div>
                        <p class="control is-expanded">
                            <input class="input is-rounded" type="text" name="txt_buscador" placeholder="Buscar..." pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" maxlength="30" value="<?php echo isset($_SESSION['busqueda_categoria']) ? htmlspecialchars($_SESSION['busqueda_categoria']) : ''; ?>">
                        </p>
                        <p class="control">
        ...
        <div class="columns" style="margin-bottom:0px">
            <div class="column">
                <form class="has-text-centered" action="" method="POST" autocomplete="off" >
                    ...
                    <?php
                        if(!empty($_SESSION['busqueda_categoria'])){
                            echo '
                                <div class="container is-fluid">
                                    <span class="subtitle has-background-white p-2">Estas buscando: <strong>'.$_SESSION['busqueda_categoria'].'</strong></span>
                                </div>
